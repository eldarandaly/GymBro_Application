...
class MuscleGroupSelector extends StatefulWidget {
  ...
  MuscleGroupSelector({required this.workoutSession});
  @override
...
class _MuscleGroupSelectorState extends State<MuscleGroupSelector> {
  ...
  String _colorTarget() {
    List<WorkoutData> workdataExe = widget.workoutSession.workoutData;
    List<String> exerciseNames = [];
    List<String> targetNames = [];
    workdataExe.forEach((element) {
      exerciseNames.add(element.exercise);
    });
    List<Exercise> matchingExercises = Exercise.exercises
        .where((exercise) => exerciseNames.contains(exercise.name))
        .toList();

    List<List<String?>?> primaryMuscles =
        matchingExercises.map((exercise) => exercise.primaryMuscles).toList();

    primaryMuscles.forEach((element) {
      targetNames.add(element![0].toString());
    });
    // print(targetNames);
    if (targetNames.isEmpty) {
      return svgCode;
    }
    String newSvgCode = svgCode;
    setState(() {
      String notTargetColorTrapezius = '#262610';
      String notTargetColorLats = '#262611';
      String notTargetColorTriceps = '#262613';
      String notTargetColorForearms = '#262614';
      String notTargetColorGlutes = '#262615';
      String notTargetColorHamstrings = '#262616';
      String notTargetColorCalves = '#262617';
      String notTargetColorDeltoids = '#262618';
      String notTargetColorBiceps = '#262619';
      String notTargetColorPectorals = '#262620';
      String notTargetColorObliques = '#262621';
      String notTargetColorAbs = '#262622';
      String notTargetColorQuads = '#262623';
      String notTargetColorAdductors = '#262624';

      // String notTargetColorRhomboids = '';

      String targetColor = '#ff0000';

      setState(() {
        for (String muscle in targetNames) {
          if (muscle == 'Trapezius' || muscle == 'traps') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorTrapezius, targetColor);
          } else if (muscle == 'lats' || muscle == 'middle back') {
            newSvgCode = newSvgCode.replaceAll(notTargetColorLats, targetColor);
          } else if (muscle == 'forearms') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorForearms, targetColor);
          } else if (muscle == 'triceps') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorTriceps, targetColor);
          } else if (muscle == 'Glutes' || muscle == 'glutes') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorGlutes, targetColor);
          } else if (muscle == 'Hamstrings') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorHamstrings, targetColor);
          } else if (muscle == 'biceps') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorBiceps, targetColor);
          } else if (muscle == 'Abs' || muscle == 'abdominals') {
            newSvgCode = newSvgCode.replaceAll(notTargetColorAbs, targetColor);
          } else if (muscle == 'Quads' || muscle == 'quadriceps') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorQuads, targetColor);
          } else if (muscle == 'Adductors') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorAdductors, targetColor);
          } else if (muscle == 'Calves') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorCalves, targetColor);
          } else if (muscle == 'Deltoids' || muscle == 'shoulders') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorDeltoids, targetColor);
          } else if (muscle == 'Pectorals' || muscle == 'chest') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorPectorals, targetColor);
          } else if (muscle == 'Obliques') {
            newSvgCode =
                newSvgCode.replaceAll(notTargetColorObliques, targetColor);
          }
        }
      });
    });
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // CheckboxListTile(
            //   title: Text('Biceps'),
            //   value: selectedMuscles.contains('biceps'),
            //   onChanged: (value) => toggleMuscle('biceps'),
            // ),
            // CheckboxListTile(
            //   title: Text('Deltoids'),
            //   value: selectedMuscles.contains('deltoids'),
            //   onChanged: (value) => toggleMuscle('deltoids'),
            // ),
            // CheckboxListTile(
            //   title: Text('Forearms'),
            //   value: selectedMuscles.contains('forearms'),
            //   onChanged: (value) => toggleMuscle('forearms'),
            // ),
            // CheckboxListTile(
            //   title: Text('Triceps'),
            //   value: selectedMuscles.contains('triceps'),
            //   onChanged: (value) => toggleMuscle('triceps'),
            // ),
            // SizedBox(height: 16),
            // Text(
            //   'Back',
            ...
            // ),
            // CheckboxListTile(
            //   title: Text('Trapezius'),
            //   value: selectedMuscles.contains('trapezius'),
            //   onChanged: (value) => toggleMuscle('trapezius'),
            // ),
            // CheckboxListTile(
            //   title: Text('Lats'),
            //   value: selectedMuscles.contains('lats'),
            //   onChanged: (value) => toggleMuscle('lats'),
            // ),
            // CheckboxListTile(
            //   title: Text('Rhomboids'),
            //   value: selectedMuscles.contains('rhomboids'),
            //   onChanged: (value) => toggleMuscle('rhomboids'),
            // ),
            // SizedBox(height: 16),
            // Text(
            //   'Legs',
            ...
            //   value: selectedMuscles.contains('quadriceps'),
            //   onChanged: (value) => toggleMuscle('quadriceps'),
            // ),
            // CheckboxListTile(
            //   title: Text('Hamstrings'),
            //   value: selectedMuscles.contains('hamstrings'),
            //   onChanged: (value) => toggleMuscle('hamstrings'),
            // ),
            // CheckboxListTile(
            //   title: Text('Calves'),
            //   value: selectedMuscles.contains('calves'),
            //   onChanged: (value) => toggleMuscle('calves'),
            // ),
            // SizedBox(height: 16),
            // Text(
            //   'Selected Muscles:',
